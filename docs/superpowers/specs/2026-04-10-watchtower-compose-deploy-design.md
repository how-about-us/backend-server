...
- The current source of truth is [docs/ai/decisions/20260409-1659-self-hosted-runner-deploy.md](/docs/ai/decisions/20260409-1659-self-hosted-runner-deploy.md).
- The active workflow is [deploy-compose.yml](/.github/workflows/deploy-compose.yml).
